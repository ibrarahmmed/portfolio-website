            ...
            <div className='flex flex-col md:flex-row items-start justify-start'>
                ...
                <motion.div
                    ...
                    <div className='md:w-10/12 text-lg text-[#666] mb-8'>
                        ...
                        <p className='mb-5'>I am a student of Electronics and Communication Engineering at Hajee Mohammed Danesh Science and Technology University. To initiate my career as a web developer before completing my graduation. Always strive to bring 100% to the work I do</p>
                        <p className='mb-5'>I have worked on technologies like HTML5, CSS, Javascript, Reactjs, NextJs, NodeJs, MongoDB, C++ during my bachelor's.</p>

                        <p className='mb-5'>I'm a <strong> Web Developer</strong> building the Front-end of Websites and Web Applications that leads to the success of the overall product. Check out some of my work in the <strong>Projects</strong> section.</p>

                        

                        <p className='mb-5'>I also like sharing content related to the stuff that I have learned over the years in <strong>Web Development</strong> so it can help other people of the Dev Community. Feel free to Connect or Follow me on my <a href="https://www.linkedin.com/in/ibrar-ahmmed-b7b665299/" className='text-secondary font-bold underline'>Linkedin</a> where I post useful content related to Web Development and Programming</p>
